...
?>
                            ...
                            <table  class="highlight white z-depth-1 " style="height:100%!important;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{email_address}</td>
                                        <td id=""><a class="grey-text" href="<?php echo site_url('admin/edituser/')?>{auto_generated_id}"><i class="material-icons">mode_edit</i></a></td>
    ...
    <?php adminjs();?>
        ...
        <script>
            ...
            var del = (id) =>{
                $.post("<?php echo site_url('cms/DeleteUser')?>",{id:id},function(res){
