                ...
                <div class="row">
                    ...
                    <div class="col l8 m10 s12 offset-m1 offset-l2 offset-s0" style="margin-top:50px;">
                        ...
                        <div class="row white image-sec z-depth-1">
                            ...
                            <div class="col s12">
                                <input id="fname" name="first_name" class="abt" type="text" value="<?php ?>" disabled/>
                                <label for="fname">First Name</label>
                            </div>

                            <div class="col s12">
                                <input id="lname" name="last_name" class="abt"  type="text" value="<?php ?>" disabled/>
                                <label for="lname">Last Name</label>
                            </div>
                            
                            <div class="col s12">
                                <input id="phone" name="user_phone" class="abt"  type="text" value="<?php ?>" disabled/>
                                <label for="phone">Phone Number</label>
                            </div>

                            <div class="col s12">
                                <input id="city" name="user_city" class="abt"  type="text" value="<?php ?>" disabled/>
                                <label for="city">City</label>
                            </div>

                            <div class="col s12">
                                <input id="state" name="user_state" class="abt"  type="text" value="<?php ?>" disabled/>
                                <label for="state">State</label>
                            </div>

                            <div class="col s12">
                                <input id="zip" name="user_zip" class="abt"  type="text" value="<?php ?>" disabled/>
                                <label for="zip">Zip</label>
                            </div>

                            <div class="col s12">
                                <input id="email" name="email_address" class="abt"  type="text" value="<?php ?>" disabled/>
                                <label for="email">Email</label>
                            </div>

                            <div class="col s12">
                                <input id="password" name="user_password" class="abt"  type="text" value="<?php ?>" disabled/>
