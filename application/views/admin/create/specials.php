                        ...
                        <div class="row">
                            ...
                            <div class="input-field col l6 m6 s12">
                                <select name="package_type">
                                    ...
                                    <option value="3">Single Parent's</option>
                                    <option value="2">Couple's Pack</option>
                                    <option value="3">New Wedded Pack</option>
                                    <option value="3">First Time</option>
                                    <option value="3">Mother's / Father's Day</option>
                                    <option value="3">Loner's Pack</option>
                                    <option value="3">Summer Pack</option>
                                    <option value="3">Winter Pack</option>
                                    <option value="3">Authum Pack</option>
                                    <option value="3">Spring Pack</option>
                                    <option value="3">Christmas Special</option>
                                    <option value="3">Independence Day Pack</option>
                                    <option value="3">Birthday Pack</option>
                                    <option value="3">Party Pack</option>
                                    <option value="3">Sumfest Pack</option>
                            ...
                            <div class="input-field col l6 m6 s12">
                                ...
                                <input name="" id="packdesc" type="text"  class="validate"/>
