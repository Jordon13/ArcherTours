...
<html>
    ...
    <head>
        <title>Add Recent Activities</title>
        <?php adminhead();?>
        <style>
    ...
    <body>
        ...
        <section class="content-area">
            ...
            <div class="row inner-content valign-wrapper" style="align-items:center;">

            <form class="col l6 m10 s12 offset-s0 offset-l3 offset-m1 z-depth-1 grey lighten-4 my-form">
