...
<html lang="en">
<head>
    <title>Service | Taxi | what is a trip without the wheels? </title>
    ...
    .fpage {
        background-image: url(<?php echo base_url('assets/').$pageDetails['_taxi_img'];?>);
      ...
      <div class="col l10 m10 s12 offset-l1 offset-m1 offset-s0 center"  style="height:100%!important; z-index:4!important; position:relative;">
        <div class="row valign-wrapper" style="height:100%!important;">
          ...
          <h5 class="white-text"><a class="custom-hone-link" href="<?php echo site_url('/')?>">Home</a> | <span style="color:rgba(255,255,255,0.8)!important;">Tours</span></h5>
            <h1 class="white-text header"><?php echo $pageDetails['_taxi_title'];?></h1>
          </div>
        </div>
      </div>
                ...
                <div class="col l4 m6 s12">
                    <div class="card sticky-action">
                        ...
                        <div class="card-image waves-effect waves-block waves-light">
                            <span class="card-title" style="font-size:15px!important;">{price_place} ({trip_type}) <span class="green-text" >-{price_discount}% off 5 & over</span></span>
                        ...
                        <div class="card-reveal">
                            <span class="card-title white-text text-darken-4">Additional Information<i class="material-icons right">close</i></span>
