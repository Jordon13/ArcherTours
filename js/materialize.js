    ...
    var Dropdown = function(_Component2) {
        ...
        _createClass(Dropdown, [{
            ...
            value: function _removeTemporaryEventHandlers() {
                ...
                document.body.removeEventListener('touchmove', this._handleDocumentTouchmoveBound, { passive: true });
    ...
    var Sidenav = function(_Component8) {
        ...
        _createClass(Sidenav, [{
            ...
            value: function _removeEventHandlers() {
                ...
                this.dragTarget.removeEventListener('touchmove', this._handleDragTargetDragBound, { passive: true });
                this.dragTarget.removeEventListener('touchend', this._handleDragTargetReleaseBound);
                this._overlay.removeEventListener('touchmove', this._handleCloseDragBound, { passive: true });
                this._overlay.removeEventListener('touchend', this._handleCloseReleaseBound);
                this.el.removeEventListener('touchmove', this._handleCloseDragBound, { passive: true });
